...
class MainProcess:
    ...
    def waitSaveTheFlag(self):
        ...
        hH = 100        
        editLine = ii[8]
        # f'checkFlag|||IMG|||{tol}|||{comm}|||{mess}|||{seqFile}|||TAB|||TAB9|||TAB10'
        ...
        if self.editIt=='True':
            ...
            print(oldFlag)
            newLine = f'{seqName}|||{oldFlag}|||{tol}|||{comm}|||{mess}|||{seqFile}|||TAB8|||TAB9|||TAB10'
            print(newLine)
            ...
            proName = self.projectName   
            newLine = f'{seqName}|||./dataProjects/{self.projectName}/flag_{countId}.png|||{tol}|||{comm}|||{mess}|||{seqFile}|||TAB|||TAB9|||TAB10\n'
            controlID = editLine
            ...
            f.write(f's{curId}:#$%^&*(st)|||{seqName}|||./dataProjects/{self.projectName}/flag_{countId}.png|||{tol}|||{comm}|||{mess}|||{seqFile}|||TAB|||TAB9|||TAB10\n')
            f.close()
            # f'checkFlag|||IMG|||{tol}|||{comm}|||{mess}|||{seqFile}|||TAB|||TAB9|||TAB10'
